...
main figure img{{margin-inline:auto;max-height:620px;object-fit:contain}}.feature-figure{{background:#fff;border:1px solid var(--line);border-radius:18px;padding:clamp(14px,2.5vw,28px)}}.feature-figure img{{max-height:460px}}iframe{{width:100%;height:min(68vw,680px);min-height:560px;border:1px solid var(--line);border-radius:14px;background:#fff}}p code{{overflow-wrap:anywhere;word-break:break-word}}pre{{max-width:100%;max-height:680px;overflow:auto;background:#10263a;color:#eaf2f6;border-radius:14px;padding:20px;font:13px/1.55 Consolas,monospace}}pre code{{overflow-wrap:normal;word-break:normal}}
